  ...
  visuals: [
    {
      ...
      images: [
        {
          src: "/images/case-studies/hem/homepage.png",
    ...
    },
    {
      ...
      images: [
        {
          src: "/images/case-studies/hem/tshirt-design.png",
  ...
  visuals: [
    {
      ...
      images: [
        {
          src: "/images/case-studies/stormyops/admin-dashboard.png",
          alt: "StormyOps CMS admin dashboard",
        },
        {
          src: "/images/case-studies/stormyops/post-dashboard.png",
          alt: "StormyOps CMS post dashboard",
        },
        {
          src: "/images/case-studies/stormyops/add-edit-post.png",
